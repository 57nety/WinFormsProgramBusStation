...
System::Void practical_work::flight_output_on_request::вернутьсяВToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e)
{
	remove("look_for.txt");
...
// выйти из программы
System::Void practical_work::flight_output_on_request::выйтиИзПрограммыToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e)
{
	remove("look_for.txt");
	Application::Exit();
}
// об окне
System::Void practical_work::flight_output_on_request::обОкнеToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e)
{
...
System::Void practical_work::flight_output_on_request::flight_output_on_request_Shown(System::Object^  sender, System::EventArgs^  e)
{
	FILE *fptr;
...
// шапка таблицы
void practical_work::flight_output_on_request::Header()
{
...
void practical_work::flight_output_on_request::Show()
{
	FILE *fptr;
	char flight_number[SIZE] = {},destination[SIZE] = {},departure_date[SIZE] = {},departure_time[SIZE] = {},total_number_of_seats[SIZE] = {},ticket_price[SIZE] = {};
	int i;
...
// желаемая дата
System::Void practical_work::flight_output_on_request::t3_TextChanged(System::Object^  sender, System::EventArgs^  e)
{
...
// желаемое время
System::Void practical_work::flight_output_on_request::t4_TextChanged(System::Object^  sender, System::EventArgs^  e)
{
...
System::Void practical_work::flight_output_on_request::t5_TextChanged(System::Object^  sender, System::EventArgs^  e)
{
...
// желаемая цена
System::Void practical_work::flight_output_on_request::t6_TextChanged(System::Object^  sender, System::EventArgs^  e)
{
...
// применить фильтр
System::Void practical_work::flight_output_on_request::button1_Click(System::Object^  sender, System::EventArgs^  e)
{
	FILE *fptr;
	int flag, k, counter;
