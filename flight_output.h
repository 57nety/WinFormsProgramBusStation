...
namespace practical_work {
	...
	/// <summary>
	/// —водка дл€ flight_output
	/// </summary>
	public ref class flight_output : public System::Windows::Forms::Form
	{
	public:
		flight_output(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Location = System::Drawing::Point(12, 47);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Size = System::Drawing::Size(1328, 601);
			...
			this->dataGridView->Size = System::Drawing::Size(1316, 574);
			...
			this->вернутьс€¬ToolStripMenuItem->Click += gcnew System::EventHandler(this, &flight_output::вернутьс€¬ToolStripMenuItem_Click);
			// 
			...
			this->выйти»зѕрограммыToolStripMenuItem->Click += gcnew System::EventHandler(this, &flight_output::выйти»зѕрограммыToolStripMenuItem_Click);
			// 
			...
			this->обќкнеToolStripMenuItem->Click += gcnew System::EventHandler(this, &flight_output::обќкнеToolStripMenuItem_Click);
			// 
			// flight_output
			// 
			...
			this->Name = L"flight_output";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"¬ывод всех имеющихс€ рейсов";
			this->Shown += gcnew System::EventHandler(this, &flight_output::flight_output_Shown);
...
private: System::Void flight_output_Shown(System::Object^  sender, System::EventArgs^  e);
// шапка таблицы
private: void Header();
