...
System::Void practical_work::found_flights::found_flights_Shown(System::Object^  sender, System::EventArgs^  e)
{
	FILE *fptr;
...
// шапка таблицы
void practical_work::found_flights::Header()
{
...
void practical_work::found_flights::Show()
{
	FILE *fptr;
	char flight_number[SIZE] = {},destination[SIZE] = {},departure_date[SIZE] = {},departure_time[SIZE] = {},total_number_of_seats[SIZE] = {},ticket_price[SIZE] = {};
	int i;
