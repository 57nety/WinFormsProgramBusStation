...
System::Void practical_work::flight_output_user::вернутьсяВToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e)
{
...
// выйти из программы
System::Void practical_work::flight_output_user::выйтиИзПрограммыToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e)
{
	Application::Exit();
}
// об окне
System::Void practical_work::flight_output_user::обОкнеToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e)
{
	MessageBox::Show("В данном окне вы видите все имеющиеся рейсы в базе данных. Также вы можите вернуться в Меню посетителя или выйти из программы.","Об окне");
}
// вывод рейсов при загрузке формы
System::Void practical_work::flight_output_user::flight_output_user_Shown(System::Object^  sender, System::EventArgs^  e)
{
	FILE *fptr;
...
// шапка таблицы
void practical_work::flight_output_user::Header()
{
...
void practical_work::flight_output_user::Show()
{
	FILE *fptr;
	char flight_number[SIZE] = {},destination[SIZE] = {},departure_date[SIZE] = {},departure_time[SIZE] = {},total_number_of_seats[SIZE] = {},ticket_price[SIZE] = {};
	int i;
